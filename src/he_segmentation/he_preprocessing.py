...
def preprocess_he(img_: np.ndarray, square_size_: Optional[int], model_version_: str, stain_: str = None,
                  prob_thrsh_: float = None, nms_thrsh_: float = None, n_tiles_: tuple = (15, 19, 1)):
    ...
    print(f"Running Stardist: {model_version_}, h&e {square_size} with tile {n_tiles_}")
